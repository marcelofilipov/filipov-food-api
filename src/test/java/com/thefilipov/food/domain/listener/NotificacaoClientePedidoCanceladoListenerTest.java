...
class NotificacaoClientePedidoCanceladoListenerTest {
    ...
    @InjectMocks
    private NotificacaoClientePedidoCanceladoListener notificacaoClientePedidoCanceladoListenerUnderTest;

    @Test
    void testAoCancelarPedido() {
        // Setup
        ...
        // Run the test
        notificacaoClientePedidoCanceladoListenerUnderTest.aoCancelarPedido(event);
